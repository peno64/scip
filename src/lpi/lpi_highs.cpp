...
/*
 * FIXME: Ugly hack to add a public inline method to zero all clocks, upstream this method!
 * An alternative may be to set time limit always to getHighsRunTime() + time limit
 */
#define getHighsRunTime() getHighsRunTime(); void zeroAllClocks() { timer_.zeroAllClocks(); }
#include <Highs.h>
#undef getHighsRunTime
